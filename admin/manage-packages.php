...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if ($_GET['action'] == 'delete') {
        $id = intval($_GET['id']);
        $query = mysqli_query($conn, "DELETE FROM tbltourpackages WHERE PackageId = $id");
        if ($query) {
    ...
    <head>
        <title>LVA | admin manage packages</title>
                                    ...
                                    if (mysqli_num_rows($query) > 0) {
                                        while ($result = mysqli_fetch_assoc($query)) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a
                                                        href="update-package.php?pid=<?php echo htmlentities($result['PackageId']); ?>">
