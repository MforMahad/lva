...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		<title>LVA | Admin manage Users</title>
									...
									if (mysqli_num_rows($result) > 0) {
										while ($row = mysqli_fetch_assoc($result)) {
											...
											<tr>
												...
												<td><a href="user-bookings.php?uid=<?php echo htmlentities($row['user_id']); ?>&&uname=<?php echo htmlentities($row['user_name']); ?>"
														class="btn btn-primary">User Bookings</a></td>
											</tr>
											<?php $cnt = $cnt + 1;
										}
									} ?>
